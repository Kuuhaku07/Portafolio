const en = {
  ...
  skills: {
    ...
    studiesCourses: [
      ...
      "Participation (2nd place) Programming Tournament 2024-1 UGMA",
      "Basic English 2nd semester at CEBA-UCV",
      "Technical Report Writing (INCES)",
      "Basic Supervision (INCES)",
      "Emotional Intelligence (PDVSA GAS)"
    ],
    languagesList: [
      { skill: "Spanish", level: 10 },
      { skill: "English", level: 7 }
    ],
